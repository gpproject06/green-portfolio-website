...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="pt-20 mc:pt-12 pb-4 bg-custom-gradient-diagonal sm:bg-custom-gradient-diagonal-bottom">
        ...
        <a href="#courses" className="flex justify-center animate-float ">
          <svg
            ...
            strokeWidth="1.5"
            stroke="white"
            className="w-12 h-12 xl:w-8 xl:h-8"
          >
            <path
              strokeLinecap="round"
      ...
      <div
        id="courses"
        className="flex flex-col items-center justify-center text-center pb-10 pt-10 scroll-mt-16 md:scroll-mt-0"
      >
        ...
        <p className="font-dmsans leading-5 text-min-blue text-sm px-4 mb-20 w-full sm:text-lg sm:w-11/12 md:mb-16 md:w-11/12 lg:text-xl xl:w-10/12 2xl:w-8/12">
          ...
          provide specialized workshops on personal finance, business skills,
      ...
      <div id="our-story" className="scroll-mt-16 md:scroll-mt-0 pb-10 pt-16">
        ...
        <div className="text-min-blue text-center py-5 md:py-7 2xl:py-10 px-7 sm:px-28 2xl:px-64 text-lg lg:text-xl">
          ...
          to provide accessible and comprehensive education in business
          development, social media marketing, personal finance, and more.
        </div>
        {/* BACKGROUND PT 2 */}
      ...
      <section
        id="resources"
        className="flex flex-col items-center  pb-10 scroll-mt-16 md:scroll-mt-0"
      >
        <p className="text-xs font-medium border border-gray-300 rounded-xl px-5 py-1 mt-7 ">
          Everything you need
        </p>

        <p className="text-3xl sm:text-4xl lg:text-5xl text-center font-bold py-5 text-gradient">
          Education, Community, <br></br>and Mentorship
        </p>

        <div className="w-auto px-5 sm:px-0  sm:w-8/12 text-center text-xl pb-20">
          Empower your journey with comprehensive learning, a{" "}
          <br className="hidden lg:block" /> supportive network, and
          personalized guidance to <br className="hidden lg:block" /> achieve
          your goals.
        </div>
        ...
        <div className="flex justify-center">
          <div
            className="grid grid-cols-1 sm:grid-cols-2 w-11/12 xs:w-9/12 xl:w-8/12 2xl:w-5/12
   lg:w-10/12 gap-6 lg:gap-10 xl:gap-14 2xl:gap-20 lg:py-0 pb-9"
      ...
      <section className="bg-black gap-10 py-10 pl-4 2xl:px-36 text-center flex flex-col sm:flex-row text-white">
        <div className="flex flex-col gap-4">
          <Image
            className="w-11 2xl:w-14 rounded-2xl shadow-md shadow-green-500"
            src={Logo}
            alt="Logo SVG"
          />
          ...
          <div className="flex flex-row gap-5 sm:pt-20 py-4">
            <a
              href="https://www.youtube.com/watch?v=9VlvbpXwLJs&t=3616s"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/green_portfolio_project?igsh=MzRlODBiNWFlZA=="
              target="_blank"
              rel="noopener noreferrer"
            >
              <Image
            ...
            <a
              href="https://www.linkedin.com/company/green-portfolio-project/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Image
            ...
            <a
              href="https://www.tiktok.com/@greenportfolioproject1?_t=8pIWxByNnCQ&_r=1"
              target="_blank"
              rel="noopener noreferrer"
            >
